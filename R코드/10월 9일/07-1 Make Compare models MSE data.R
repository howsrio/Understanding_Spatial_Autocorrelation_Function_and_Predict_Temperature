...
Compare_model_result=matrix(NA,nrow=20,ncol=3)
...
year=rep(c(2002,2007,2012,2017,2022), 4)
season=rep(c('Spring',"Summer","Fall","Winter"), c(5,5,5,5))
a=cbind(year,season,Compare_model_result)
