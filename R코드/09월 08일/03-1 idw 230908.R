...
grd_korea_df=as.data.frame(grid_korea)

grd.sp <- SpatialPointsDataFrame(coords=grid_korea,grd_korea_df, proj4string=CRS("+proj=utm +zone=48 +datum=WGS84"))  
...
#파일로 반환
write.xlsx(grd_idw_df, cat(sub,"k =",best_k,"idw grd df.xlsx"))
