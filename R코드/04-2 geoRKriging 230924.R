...
krigpreds <- krige.conv(sp.dat2, coords=rem_c, data=rem_tem, location=sam_c, krige=krige.control(cov.pars=c(fit.rem$cov.pars[1], fit.rem$cov.pars[2]),kappa=fit.rem$kappa))
...
#image.plot(surf1,xaxs="r",yaxs="r",xlab=" ",ylab=" ",col=col,main="Kriging Predictor")
